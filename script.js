...
for(let p of particles){      
  ...
  // Ajuste en la expresión regular para que funcione correctamente con 'rgba(..., 0.95)'
  grd.addColorStop(0.15, p.hue.replace('0.95)', '0.35)'));      
...
// --- Firebase Configuración (unchanged from your last paste) ---
...
// **CORREGIDO:** Definición del elemento de Telegram
...
// --- sanitize email (CORREGIDO: MOVÍ LA FUNCIÓN AQUÍ para que se defina antes de usarse) ---
...
// -----------------------------------------------------------------
// --- LÓGICA DE VINCULACIÓN DE TELEGRAM (INTEGRADA Y CORREGIDA) ---
// -----------------------------------------------------------------
if (menuTelegramBot) {
    menuTelegramBot.addEventListener("click", async () => {
        ...
        // *** IMPORTANTE: CAMBIA "TU_BOT_AQUI" por el usuario real de tu bot ***
